...
const Portfolio: React.FC = () => {
  ...
  const headingInterval = reducedMotion ? 0 : 102;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects?.map((project, idx) => (
              <motion.div
                ...
                className="group relative bg-[#0a0a0a] border border-white/5 rounded-2xl overflow-hidden hover:border-[#00D2FF]/40 transition-all hover:shadow-[0_0_30px_rgba(0,210,255,0.2)]"
              >
