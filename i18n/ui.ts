...
export const UI_TEXT = {
  pt: {
    ...
    contactPreferredChannel: 'Canal preferido',
    contactWhatsTitle: 'Conversar no WhatsApp',
    contactWhatsSubtitle: 'Resposta rápida — agendamos uma reunião com a TechT em poucos minutos.',
    contactWhatsOnline: 'Online agora',
    contactWhatsCta: 'Abrir conversa',
    contactAlsoAt: 'Também estamos em',
  ...
  en: {
    ...
    contactPreferredChannel: 'Preferred channel',
    contactWhatsTitle: 'Talk on WhatsApp',
    contactWhatsSubtitle: 'Fast reply — we book a meeting with TechT within minutes.',
    contactWhatsOnline: 'Online now',
    contactWhatsCta: 'Open chat',
    contactAlsoAt: 'Also at',
