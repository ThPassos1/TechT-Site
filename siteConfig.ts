...
export const SITE_CONFIG = {
  ...
  brand: {
    ...
    logoGlow: "#00D2FF",
    logoImage: "", // Deixe vazio para usar a logo em vetor padrão
  },
  ...
  hero: {
    ...
    titlePart2: " de Elite.",
    description: "A TechT une engenharia de software de ponta com estratégias de tráfego agressivas para impulsionar seu faturamento no ambiente digital.",
    ctaButton: "Quero Crescer Agora",
  },

  // BLOG: Adicione ou edite suas postagens aqui
  blog: {
    title: "Insights Tecnológicos",
    subtitle: "Explorando a próxima fronteira da inovação digital e estratégias de growth.",
    posts: [
      {
        id: "post-1",
        title: "Criptografia Quântica: O Futuro da Segurança Digital",
        excerpt: "Como as novas tecnologias de criptografia estão se preparando para a era da computação quântica e o que isso significa para sua empresa.",
        date: "24 de Outubro, 2025",
        author: "Thiago Passos",
        category: "CIBERSEGURANÇA",
        image: blogCriptografiaImg, // ← Aqui usamos a importação
      ...
      
      {
        ...
        excerpt: "Descubra os segredos psicológicos por trás das páginas que convertem 3x mais que a média do mercado.",
      ...
      },
      {
        ...
        excerpt: "Reduza custos de infraestrutura e aumente a escalabilidade do seu sistema usando funções sem servidor.",
      ...
      },
      {
        ...
        excerpt: "Como os novos algoritmos de inteligência artificial do Facebook estão mudando a forma como segmentamos públicos.",
  ...
  portfolio: [
    {
      ...
      description: "Desenvolvimento de presença digital robusta com foco em autoridade de marca e carregamento instantâneo.",
    ...
    },
    {
      ...
      description: "Lojas virtuais de alta performance preparadas para grandes volumes de tráfego e checkout seguro.",
      category: "Growth",
      imageUrl: ecomerce,
    ...
    },
    {
      ...
      description: "Soluções de software complexas desenvolvidas sob medida para resolver dores específicas do seu negócio.",
      category: "Engenharia",
      imageUrl: barbearia,
    ...
    },
    {
      id: "sistemas",
      title: "Dashboards",
      description: "Visualização de dados em tempo real para tomada de decisão baseada em números, não em achismos.",
  ...
  intelligence: {
    ...
    titleSuffix: " Total.",
    description: "Esqueça relatórios estáticos em PDF. Nosso sistema proprietário consolida dados de todas as suas fontes de tráfego em um dashboard vivo e inteligente.",
    metrics: [
  ...
  traffic: {
    ...
    description: "Não fazemos apenas anúncios. Construímos funis de vendas de alta performance que utilizam inteligência de dados para encontrar seu cliente ideal onde ele estiver.",
    features: [
      {
  ...
  about: {
    ...
    image: "./thiago.jpg",
    description: "A TechT nasceu da visão de que o desenvolvimento de software não deve ser apenas funcional, mas uma obra de arte tecnológica. Sob a liderança de Thiago Passos, transformamos desafios complexos em ecossistemas digitais fluidos.",
  ...
  contact: {
    ...
    description: "Pronto para elevar seu ecossistema digital? Fale com nosso time de especialistas para arquitetar sua presença online.",
